    ...
    <div class="cart-info">
      ...
      <div class="calc">
        <el-row class="pay-row">
          ...
          <el-col :span="8">
            <span class="alipay"><img src="../../static/image/alipay2.png" alt="" @click="pay_type=1"></span>
            <span class="wechat"><img src="../../static/image/wechat.png" alt="" @click="pay_type=2"></span>
          </el-col>
